...
<h4 style="text-align:center">Alunos em Espera</h4>
<br>
...
@endforeach
        ...
        <br>
<div class="teste1"><h7 style="text-align:left">Total de Alunos Deletados: {{$aluno1->count()}}</h7></div>
