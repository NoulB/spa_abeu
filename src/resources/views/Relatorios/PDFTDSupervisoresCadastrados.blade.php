...
<br><br><br>
<h4 style="text-align:center">Todos os Supervisores Ativos</h4>
...
@foreach($supervisores3 as $supervisores )
    <tr>
...
<br>
<div class="teste1"><h7 style="text-align:left">Total de Supervisores Ativos: {{$supervisores3->count()}}</h7></div>
