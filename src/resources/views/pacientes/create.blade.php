                ...
                <div class="col">
                          Disponibilidade:<br/>
                            <div class="form-check form-check-inline" id="total">
                                <input class="form-check-input" type="checkbox" name="disponibilidade" id="Total1" value="1d" onclick="myFunction()" >
                                <label class="form-check-label" for="Total1" >Total</label>
                            </div>
                            <div class="form-check form-check-inline" id="segunda" >
                                <input class="form-check-input" type="checkbox" name="disponibilidade" id="tipo2" value="2" onclick="myFunction10()" >
                                <label class="form-check-label" for="tipo2">Segunda</label>
                            </div>
                            <div class="form-check form-check-inline" id="terca">
                                <input class="form-check-input" type="checkbox" name="disponibilidade" id="tipo3" onclick="myFunction9()" >
                                <label class="form-check-label" for="tipo3">Terça</label>
                            </div>
                            <div class="form-check form-check-inline" id="quarta">
                                <input class="form-check-input" type="checkbox" name="disponibilidade" id="tipo4" onclick="myFunction8()">
                                <label class="form-check-label" for="tipo4">Quarta</label>
                            </div>
                            <div class="form-check form-check-inline" id="quinta">
                                <input class="form-check-input" type="checkbox" name="disponibilidade" id="tipo5" onclick="myFunction7()">
                                <label class="form-check-label" for="tipo5">Quinta</label>
                            </div>
                            <div class="form-check form-check-inline" id="sexta">
                                <input class="form-check-input" type="checkbox" name="disponibilidade" id="tipo6" value="6" onclick="myFunction6()">
                                <label class="form-check-label" for="tipo6">Sexta</label>
                            </div>
                            <div class="form-check form-check-inline" id="sabado">
                                <input class="form-check-input" type="checkbox" name="disponibilidade" id="tipo7" value="7" onclick="myFunction5()">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-check form-check-inline" id="total2">
                                <input class="form-check-input" type="checkbox" name="Turno" id="Total22" value="1t" onclick="myFunction1()" >
                                <label class="form-check-label" for="Total22" >Total</label>
                            </div>
                            <div class="form-check form-check-inline" id="manha" >
                                <input class="form-check-input" type="checkbox" name="Turno" id="tipomanha" value="2" onclick="myFunction2()" >
                                <label class="form-check-label" for="tipomanha">Manhã</label>
                            </div>
                            <div class="form-check form-check-inline" id="tarde">
                                <input class="form-check-input" type="checkbox" name="Turno" id="tipotarde" value="3" onclick="myFunction3()">
                                <label class="form-check-label" for="tipotarde">Tarde</label>
                            </div>
                            <div class="form-check form-check-inline" id="noite">
                                <input class="form-check-input" type="checkbox" name="Turno" id="tiponoite" value="4" onclick="myFunction4()">
