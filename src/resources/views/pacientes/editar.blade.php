    ...
    <div>
        ...
        <form name ="form1" action="{{ url("/pacientes/update/") }}" method="post">
            ...
            <div class="row">
                <div class="col">
                    CPF: <br/>
                    <input class="form-control" autocomplete="novo-" readonly=“true” id="inputcpf" placeholder="somente números" type="text" name="cpf"
                           value="{{ $paciente->cpf }}" tabindex="2" onkeypress="return isNumberKey(event)" required required maxlength="11" />
                </div>
                <div class="col">
                    RG: <br/>
                    <input class="form-control" autocomplete="novo-" id="input3" placeholder="somente números" type="text"
                           name="rg" value="{{ $paciente->rg }}" tabindex="3" onkeypress="return isNumberKey(event)" size="20" maxlength="16" required/>
                </div>
                <div class="col">
                    Data de Nascimento:<br/>
                    <input class="form-control col-md-11" autocomplete="novo-" id="input4" type="date" min="1800-12-31" max="2999-12-31" name="data_nascimento"
                           value="{{ $paciente->data_nascimento }}" tabindex="4" required/>
                </div>
                <div class="col">
                    Idade:<br/>
                    <input class="form-control col-md-7" autocomplete="novo-" type="num" name="idade" id="idade" class="form-control" placeholder="Idade" disabled
            ...
            <div>
                <div class="row">
                    <div class="col">
                        E-mail: <br/>
                        <input class="form-control" autocomplete="novo-" size="10" id="input5" placeholder="E-mail" type="text" name="email"
                    ...
                    <div class="col">
                        <div class="row">
                            <div class="col">
                                Celular: <br/>
                                <input class="form-control col-md-11" autocomplete="novo-" id="inputcel" placeholder="Somente números"
                            ...
                            <div class="col">
                                <div class="row">
                                    <div class="col">
                                        Telefone:<br/>
                                        <input class="form-control col-md-7" autocomplete="novo-" id="inputtel" placeholder="Telefone" type="text"
            ...
            <div>
                <div class="row">
                    <div class="col">
                        Nome do Pai:<br/>
                        <input class="form-control" autocomplete="novo-" id="input8" placeholder="Nome do Pai" type="text" name="pai"
                               value="{{ $paciente->pai }}"
                               tabindex="9" maxlength="256"/>
                    </div>
                    <div class="col">
                        Nome do Mae:<br/>
                        <input class="form-control" autocomplete="novo-" id="input9" placeholder="Nome da Mãe" type="text" name="mae"
                               value="{{ $paciente->mae }}"
                               required
            ...
            <div class="row">
                ...
                <div class="col">
                    CEP: <br/>
                    <input class="form-control col-md-6" autocomplete="novo-" id="inputcep" placeholder="CEP" type="text" name="cep"
                           value="{{ $paciente->cep }}"
